...
HTML5
CSS3 (Flexbox e variáveis em :root)

🎯 Objetivos do projeto

Praticar estruturação semântica em HTML
Trabalhar centralização e layout com Flexbox
Utilizar variáveis CSS para padronização de cores
Criar um design simples e organizado
